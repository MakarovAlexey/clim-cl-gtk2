...
(defclass cl-gtk2-frame-manager (frame-manager)
  ())
...
(defmethod make-pane-1
    ((fm cl-gtk2-frame-manager) (frame application-frame) type &rest initargs)
  (apply #'make-pane-2
...
;;;  (apply #'make-instance cl-gtk2-check-box-pane initargs))
;;;(defmethod make-pane-2 ((type (eql 'clim:radio-box-pane)) &rest initargs)
;;;  (apply #'make-instance cl-gtk2-radio-box-pane initargs))
...
(defmethod adopt-frame :after
    ((fm cl-gtk2-frame-manager) (frame application-frame))
  ())

(defmethod note-space-requirements-changed :after ((graft cl-gtk2-graft) pane)
  ())

;;; ";; Temporary kludge." says the CLX backend.  Ha-ha.
(defmethod adopt-frame
    :before
    ((fm cl-gtk2-frame-manager) (frame climi::menu-frame))
...
(defmethod frame-manager-menu-choose
    ((frame-manager cl-gtk2-frame-manager)
     items
