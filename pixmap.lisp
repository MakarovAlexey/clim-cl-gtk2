...
(defclass cl-gtk2-pixmap (climi::mirrored-pixmap) ())
...
(defmethod pixmap-depth ((pixmap-sheet cl-gtk2-pixmap))
...
(defmethod medium-copy-area
    ((from-medium cl-gtk2-medium) from-x from-y width height
     (to-medium cl-gtk2-medium) to-x to-y)
...
(defmethod medium-copy-area
    ((from-medium cl-gtk2-medium) from-x from-y width height
     (to-medium cl-gtk2-pixmap) to-x to-y)
  (climi::with-transformed-position
      ((sheet-native-transformation (medium-sheet from-medium))
       from-x from-y)
    (%medium-copy-area from-medium from-x from-y width height
...
(defmethod medium-copy-area
    ((from-medium cl-gtk2-pixmap) from-x from-y width height
     (to-medium cl-gtk2-medium) to-x to-y)
  (climi::with-transformed-position
      ((sheet-native-transformation (medium-sheet to-medium))
       to-x to-y)
